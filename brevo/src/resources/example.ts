...
exampleResource
  ...
  .addHelpText("after", "\nExamples:\n  brevo-cli examples list\n  brevo-cli examples list --limit 5 --json")
...
exampleResource
  ...
  .option("--json", "Output as JSON")
  .addHelpText("after", '\nExample:\n  brevo-cli examples create --name "My Example"')
  .action(async (opts: ActionOpts) => {
    try {
...
exampleResource
  ...
  .option("--json", "Output as JSON")
  .addHelpText("after", '\nExample:\n  brevo-cli examples update abc123 --name "Updated"')
  .action(async (id: string, opts: ActionOpts) => {
    try {
...
exampleResource
  ...
  .argument("<id>", "Example ID")
  .option("--json", "Output as JSON")
  .addHelpText("after", "\nExample:\n  brevo-cli examples delete abc123")
  .action(async (id: string, opts: ActionOpts) => {
    try {
